...
values (1, 'admin', 1234);
--
insert into user_entity (user_idx, username, password, name, email)
values
...
values
    ...
    (3, '드래곤 길들이기 공지', '드래곤 길들이기 내용', 'notice');
--
...
values
    ...
    ('드래곤 길들이기', '코멘트 내용4', '모험', '4', '2'),
    ('드래곤 길들이기', '코멘트 내용5', '모험', '5', '2'),
    ('드래곤 길들이기', '코멘트 내용6', '모험', '6', '2'),
    ('드래곤 길들이기', '코멘트 내용7', '모험', '7', '2'),
    ('드래곤 길들이기', '코멘트 내용8', '모험', '8', '2'),
    ('드래곤 길들이기', '코멘트 내용9', '모험', '9', '2'),
    ('드래곤 길들이기', '코멘트 내용10', '모험', '10', '2'),
    ('드래곤 길들이기', '코멘트 내용11', '모험', '11', '2'),
    ('드래곤 길들이기', '코멘트 내용12', '모험', '12', '2'),
    ('드래곤 길들이기', '코멘트 내용13', '모험', '13', '2'),
    ('드래곤 길들이기', '코멘트 내용14', '모험', '14', '2'),
    ('드래곤 길들이기', '코멘트 내용15', '모험', '15', '2'),
    ('드래곤 길들이기', '코멘트 내용16', '모험', '16', '2');
--
